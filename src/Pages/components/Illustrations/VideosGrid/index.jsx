...
const VideosGrid = () => {
    ...
    const handlePreviousVideo = () => {
        switch(indexOfVideo){
            case "ml-0": setIdexOfVideo("ml-400");break
            case "ml-200": setIdexOfVideo("ml-0");break
            case "ml-400": setIdexOfVideo("ml-200");break
        }
    }
    const handleNextVideo = () => {
        switch(indexOfVideo){
            case "ml-0": setIdexOfVideo("ml-200");break
            case "ml-200": setIdexOfVideo("ml-400");break
            case "ml-400": setIdexOfVideo("ml-0");break
        }
    }
