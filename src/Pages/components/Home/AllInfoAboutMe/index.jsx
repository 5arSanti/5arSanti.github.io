        ...
        <section id="about-me" className="about-me">
            <div className="about-me-container">
                ...
                <div className="about-me-info-container">
                    ...
                    <p>
                        Soy desarrollador Front End Junior y Diseñador UX/UI; con gran capacidad creativa, 
                        ...
                        <br/>
                        <br/>
                        Cuento con 4 años de experiencia como Ilustrador digital, diseñador de p&aacute;ginas web, logotipos 
